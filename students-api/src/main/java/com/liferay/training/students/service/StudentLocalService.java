...
public interface StudentLocalService
	...
	public Student createStudent(long idStudent);
	...
	public Student deleteStudent(long idStudent) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student fetchStudent(long idStudent);
