...
public class StudentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByqueryTypeDocument;
	private FinderPath _finderPathWithoutPaginationFindByqueryTypeDocument;
	private FinderPath _finderPathCountByqueryTypeDocument;
	 ...
	 */
	@Override
	public List<Student> findByqueryTypeDocument(String typeDocument) {
		return findByqueryTypeDocument(
			typeDocument, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Student> findByqueryTypeDocument(
		String typeDocument, int start, int end) {

		return findByqueryTypeDocument(typeDocument, start, end, null);
	}
	...
	public List<Student> findByqueryTypeDocument(
		...
		return findByqueryTypeDocument(
			typeDocument, start, end, orderByComparator, true);
	}
	...
	public List<Student> findByqueryTypeDocument(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByqueryTypeDocument;
				finderArgs = new Object[] {typeDocument};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByqueryTypeDocument;
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Student student : list) {
					if (!typeDocument.equals(student.getTypeDocument())) {
						list = null;
		...
		if (list == null) {
			...
			if (typeDocument.isEmpty()) {
				sb.append(_FINDER_COLUMN_QUERYTYPEDOCUMENT_TYPEDOCUMENT_3);
			}
			else {
				bindTypeDocument = true;

				sb.append(_FINDER_COLUMN_QUERYTYPEDOCUMENT_TYPEDOCUMENT_2);
			}
	...
	public Student findByqueryTypeDocument_First(
		...
		Student student = fetchByqueryTypeDocument_First(
	...
	public Student fetchByqueryTypeDocument_First(
		...
		List<Student> list = findByqueryTypeDocument(
			typeDocument, 0, 1, orderByComparator);
	...
	public Student findByqueryTypeDocument_Last(
		...
		Student student = fetchByqueryTypeDocument_Last(
			typeDocument, orderByComparator);
	...
	public Student fetchByqueryTypeDocument_Last(
		...
		int count = countByqueryTypeDocument(typeDocument);
		...
		List<Student> list = findByqueryTypeDocument(
			typeDocument, count - 1, count, orderByComparator);
	...
	public Student[] findByqueryTypeDocument_PrevAndNext(
		...
		try {
			...
			array[0] = getByqueryTypeDocument_PrevAndNext(
				session, student, typeDocument, orderByComparator, true);

			array[1] = student;

			array[2] = getByqueryTypeDocument_PrevAndNext(
				session, student, typeDocument, orderByComparator, false);
	...
	protected Student getByqueryTypeDocument_PrevAndNext(
		Session session, Student student, String typeDocument,
	...
	public int countByqueryTypeDocument(String typeDocument) {
		...
		FinderPath finderPath = _finderPathCountByqueryTypeDocument;

		Object[] finderArgs = new Object[] {typeDocument};
	...
	private static final String
		_FINDER_COLUMN_QUERYTYPEDOCUMENT_TYPEDOCUMENT_2 =
			"student.typeDocument = ?";

	private static final String
		_FINDER_COLUMN_QUERYTYPEDOCUMENT_TYPEDOCUMENT_3 =
	...
	public Student updateImpl(Student student) {
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {studentModelImpl.getTypeDocument()};

			finderCache.removeResult(_finderPathCountByqueryTypeDocument, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByqueryTypeDocument, args);
			...
			if ((studentModelImpl.getColumnBitmask() &
				...
				finderCache.removeResult(
					_finderPathCountByqueryTypeDocument, args);
				finderCache.removeResult(
					_finderPathWithoutPaginationFindByqueryTypeDocument, args);

				args = new Object[] {studentModelImpl.getTypeDocument()};
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByqueryTypeDocument = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, StudentImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByqueryTypeDocument",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			});

		_finderPathWithoutPaginationFindByqueryTypeDocument = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, StudentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByqueryTypeDocument", new String[] {String.class.getName()},
			StudentModelImpl.TYPEDOCUMENT_COLUMN_BITMASK |
			StudentModelImpl.LASTNAME_COLUMN_BITMASK);

		_finderPathCountByqueryTypeDocument = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByqueryTypeDocument", new String[] {String.class.getName()});
